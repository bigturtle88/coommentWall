...
<head>
	...
	<script src="<?= App::baseUrl() ?>/app/views/js/chartist.min.js"></script>

	<script src="<?= App::baseUrl() ?>/app/views/js/cipher.js"></script>
	<script src="<?= App::baseUrl() ?>/app/views/js/diagramma.js"></script>
</head>
<body>
